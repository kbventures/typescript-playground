...
(function (MaxHeapAttempt) {
    var MaxHeap = /** @class */ (function () {
        ...
        MaxHeap.prototype.bubbleUp = function () {
            ...
            while (child > 0) {
                ...
                if (this.heap[child] < this.heap[parent_1])
                    break;
                _a = [this.heap[parent_1], this.heap[child]], this.heap[child] = _a[0], this.heap[parent_1] = _a[1];
                child = parent_1;
            }
        };
    ...
    MaxHeapAttempt.MaxHeap = MaxHeap;
})(MaxHeapAttempt || (MaxHeapAttempt = {}));
var newHeap = new MaxHeapAttempt.MaxHeap([1, 2, 3, 4, 5, 6]);
